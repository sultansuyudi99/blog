...
class ActiveSupport::TestCase
  sig { params(fixture_name: NilClass, other_fixtures: NilClass).returns(T::Array[Micropost]) }
  sig { params(fixture_name: T.any(String, Symbol), other_fixtures: NilClass).returns(Micropost) }
  sig do
    params(
  ...
  def microposts(fixture_name = nil, *other_fixtures); end
